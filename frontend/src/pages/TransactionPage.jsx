...
const TransactionPage = () => {
	...
	return (
		<div className='h-screen max-w-4xl mx-auto flex flex-col items-center'>
			<p className='md:text-4xl text-2xl lg:text-4xl font-bold text-center relative z-50 mb-4 mr-4 bg-gradient-to-r from-green-600 via-yellow-200 to-green-400 inline-block text-transparent bg-clip-text'>
          ...
          from-green-400 to-green-400 hover:from-green-600 hover:to-green-700'
					type='submit'
